...
public class AudioManager : MonoBehaviour
{
    ...
    private void Start()
    {
        if (!PlayerPrefs.HasKey("_VolumeEnabled"))
        {
            PlayerPrefs.SetInt("_VolumeEnabled", 1);
            PlayerPrefs.SetInt("_VibrationEnabled", 1);
        }

        SwitchSound(PlayerPrefs.GetInt("_VolumeEnabled") == 1);
        TurnVibration(PlayerPrefs.GetInt("_VibrationEnabled") == 1);
    }
